...
class GMM:
    ...
    def __init__(self,nTarget,nNonTarget,MtypeTarget,MTypeNonTarget):
        self.nTarget=nTarget
        self.nNonTarget=nNonTarget
        self.MtypeTarget=MtypeTarget
        self.MTypeNonTarget=MTypeNonTarget
    ...
    def _GMM_EM(self,X, gmmStart,Mtype):
        llNew = None
        llOld = None
        nIter = 0
        N = X.shape[1]
    ...
    def _LBG(self,X, iterations,nGaussian,Mtype, alpha = 0.1):
        ...
        for i in range(iterations):
            ...
            for g in GMM_i:
                ...
                GMM_i = self._GMM_EM(X, GMM_list,Mtype)
        return GMM_i
    ...
    def train(self,xTrain, xLabels):
        ...
        GMM0 = self._LBG(D0,k0,self.nNonTarget,self.MTypeNonTarget)
        GMM1= self._LBG(D1,k1,self.nTarget,self.MtypeTarget)
